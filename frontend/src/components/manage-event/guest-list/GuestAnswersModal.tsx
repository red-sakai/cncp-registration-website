...
export function GuestAnswersModal({ guest, event, onClose }: GuestAnswersModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-3xl bg-gradient-to-br from-[#0a0015] via-[#1a0533] to-[#0d1137] border border-white/10 rounded-3xl max-h-[85vh] overflow-hidden flex flex-col">
        {/* Glow Effect */}
