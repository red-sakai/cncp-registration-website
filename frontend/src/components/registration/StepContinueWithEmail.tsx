    ...
    <div className="flex flex-col h-full animate-in fade-in duration-500">
      <div className="flex flex-col items-center text-center mb-3 sm:mb-4">
        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[rgba(197,165,90,0.15)] border border-[#c5a55a]/30 flex items-center justify-center mb-2 sm:mb-3">
          {phase === "email" && <Mail size={20} className="text-[#c5a55a] sm:w-6 sm:h-6" />}
          {phase === "password" && <Lock size={20} className="text-[#c5a55a] sm:w-6 sm:h-6" />}
          {phase === "register_required" && <UserPlus size={20} className="text-[#c5a55a] sm:w-6 sm:h-6" />}
        </div>
      ...
      <p className="text-white/60 mb-4 leading-relaxed text-[11px] sm:text-sm text-center">
      ...
      {phase === "password" && (
        <form onSubmit={handleSignIn} className="space-y-5">
          <div className="space-y-2">
            ...
            <p className="text-white text-sm py-2">{email}</p>
          </div>
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                disabled={loading}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-[#c5a55a] hover:text-[#d4b96a] transition-colors disabled:opacity-50"
          ...
          <div className="flex gap-3 items-stretch pt-1">
            <button
              ...
              onClick={backToEmail}
              disabled={loading}
              className="flex-1 min-w-0 py-3.5 rounded-xl border border-white/20 hover:bg-white/5 text-white/70 font-semibold text-sm transition-all duration-200 whitespace-nowrap"
            >
              Back
            </button>
            <button
